var Component, Tag, Text, TransformComponent, a, accordion, accordionGroup, case_, ddescribe, div, each, expect, func, idescribe, if_, iit, list, ndescribe, nit, p, span, text, txt, _ref, _ref1;
...
Component = dc.Component, TransformComponent = dc.TransformComponent, Tag = dc.Tag, Text = dc.Text, txt = dc.txt, list = dc.list, func = dc.func, if_ = dc.if_, case_ = dc.case_, func = dc.func, each = dc.each, a = dc.a, p = dc.p, span = dc.span, text = dc.text, div = dc.div;

_ref1 = require('dc-controls/accordion'), accordionGroup = _ref1.accordionGroup, accordion = _ref1.accordion;
